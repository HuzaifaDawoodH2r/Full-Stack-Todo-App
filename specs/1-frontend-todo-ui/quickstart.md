...
```env
NEXT_PUBLIC_API_BASE_URL=https://huzaifa5-todo.hf.space
...
### Task Management
1. Click the floating action button (bottom right) to add a task
...
**Solution**: Ensure backdrop-filter CSS property is supported in the target browser
...
**Solution**: Check that translation files are properly loaded and formatted
